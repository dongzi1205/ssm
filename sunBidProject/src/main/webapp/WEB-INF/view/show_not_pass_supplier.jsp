...
<div class="container-fluid">
    ...
    <div style="text-align: center">
        ...
        <a href="<%=path%>/selectnotpasssupplier?pageNum=1">首页</a>
        <a href="<%=path%>/selectnotpasssupplier?pageNum=${pageInfo.prePage}">上一页</a>
        <a href="<%=path%>/selectnotpasssupplier?pageNum=${pageInfo.nextPage}">下一页</a>
        <a href="<%=path%>/selectnotpasssupplier?pageNum=${pageInfo.pages}">尾页</a>
        <%--</c:forEach>--%>
    </div>
    <%--************--%>
</div>
