...
<div class="container-fluid">
    ...
    <div style="text-align: center">
        ...
        <a href="<%=path%>/selectokfinancesupplier?pageNum=1">首页</a>
        <a href="<%=path%>/selectokfinancesupplier?pageNum=${pageInfo.prePage}">上一页</a>
        <a href="<%=path%>/selectokfinancesupplier?pageNum=${pageInfo.nextPage}">下一页</a>
        <a href="<%=path%>/selectokfinancesupplier?pageNum=${pageInfo.pages}">尾页</a>
        <%--</c:forEach>--%>
    </div>
    <%--************--%>
</div>
